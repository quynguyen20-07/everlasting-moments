...
export default function GuestManagement() {
  ...
  const handleSaveGuest = async (data: GuestInput) => {
    ...
    try {
      ...
      toast({
        title: "Lỗi",
        description: "Không thể lưu thông tin khách mời.",
        variant: "destructive",
      });
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <GuestEditDialog
        ...
        isLoading={addGuestMutation.isPending || updateGuestMutation.isPending}
      />
      <AlertDialog
        open={!!deleteTarget}
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Bạn có chắc muốn xóa khách mời "{deleteTarget?.fullName}"? Hành
